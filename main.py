...
def main():
    ...
    if len(sys.argv) == 1 or (len(sys.argv) == 2 and sys.argv[1] == "web"):
        ...
        print("\nProfiles:")
        print("  quick        - Lightning fast (10-20s) - Critical vulnerabilities only")
        print("  standard     - Fast scan (30-45s) - Core vulnerabilities (default)")
        print("  comprehensive - Complete scan (60-90s) - Full coverage")
        print("\nExamples:")
